...
for subject in subjects:
    os.makedirs("/data/group/cng/Projects/cingulate/with_bbregister" + subject + "/surfaces/equivSurfs/" + str(num_surfs) + "surfs" + "/surfs_out", exist_ok=True)
    os.makedirs("/data/group/cng/Projects/cingulate/with_bbregister" + subject + "/surfaces/" + subject + "/surf", exist_ok=True)
    os.makedirs("/data/group/cng/Projects/cingulate/with_bbregister" + subject + "/surfaces/" + subject + "/label", exist_ok=True)
    for filename in surfs:
        ...
        for file in glob.glob("**/*"+filename, recursive=True):
            ...
            dst = "/data/group/cng/Projects/cingulate/with_bbregister/" + subject + "/surfaces/equivSurfs/" + file
    ...
    for filename in myelin_files:
        ...
        for file in glob.glob("**/*"+filename, recursive=True):
            ...
            dst = "/data/group/cng/Projects/cingulate/with_bbregister/" + subject + "/surfaces/equivSurfs/" + str(num_surfs) + "surfs" + "/surfs_out/" + file
            shutil.copyfile(src, dst)
    for filename in annot_files:
        os.chdir(projectDir + subject + "/surfaces/" + subject)
        for file in glob.glob("**/*"+filename, recursive=True):
            src = projectDir + subject + "/surfaces/" + subject + "/" + file 
            dst = "/data/group/cng/Projects/cingulate/with_bbregister/" + subject + "/surfaces/" + subject + "/" + file 
            shutil.copyfile(src, dst)
    for filename in pial_files:
        ...
        for file in glob.glob("**/*"+filename, recursive=True):
            ...
            dst = "/data/group/cng/Projects/cingulate/with_bbregister/" + subject + "/surfaces/" + subject + "/surf/" + file
            shutil.copyfile(src, dst)